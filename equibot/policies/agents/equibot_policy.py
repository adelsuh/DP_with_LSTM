...
from equibot.policies.utils.equivariant_diffusion.simple_conditional_unet1d import VecConditionalUnet1D
from equibot.policies.vision.vec_layers import VecLSTM
...
class EquiBotPolicy(nn.Module):
    def __init__(self, cfg, device="cpu"):
        ...
        if self.cfg.model.use_lstm:
            self.lstm = VecLSTM(self.obs_dim, 4)
